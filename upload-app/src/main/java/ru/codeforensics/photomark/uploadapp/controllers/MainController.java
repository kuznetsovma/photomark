...
public class MainController {
  ...
  public ResponseEntity uploadFile(
    ...
    FileMetaTransfer fileMetaTransfer = new FileMetaTransfer();
    fileMetaTransfer.setClientId(clientId);
    fileMetaTransfer.setLineName(lineName);
    fileMetaTransfer.setCode(code);
    fileMetaTransfer.setFileData(file.getBytes());

    byte[] data = SerializationUtils.serialize(fileMetaTransfer);
